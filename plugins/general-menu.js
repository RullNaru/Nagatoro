...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    conn.sendHydrated(m.chat, text.trim(), '                「 ꜱᴀᴅ BOT あ⁩ 」', await genProfile(conn, m), 'https://chat.whatsapp.com/ESXOhW5UVx76XhnBnkfufQ', 'Grub Wa', null, null, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], m)
